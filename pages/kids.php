...
<body>
    ...
    <div class="container mt-4">
        <h2 class="mb-4 text-center">Kids</h2>
        
        <!-- Fetch and Display Subcategories -->
        <?php
        // Fetch all subcategories related to the Kids category
        $sqlSubcategories = "SELECT DISTINCT sub_category FROM products WHERE category = 'Kids'";
