...
<body>
    ...
    <div class="container mt-4">
        ...
        <?php
        // Fetch all subcategories related to the New Arrivals category
        $sqlSubcategories = "SELECT DISTINCT sub_category FROM products WHERE category = 'New Arrivals'";
